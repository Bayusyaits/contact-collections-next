...
type BookListModalDeleteContactViewProps = {
  handleSave: () => void,
...
export const BookListModalDeleteContactView = ({
  handleSave,
  handleCloseModal,
  isDisabled,
  loadingSubmit,
  errorMessage,
  payload,
}: BookListModalDeleteContactViewProps) => {
  return (
      <Grid
        container
        maxWidth={'lg'}
...
export default BookListModalDeleteContactView;
